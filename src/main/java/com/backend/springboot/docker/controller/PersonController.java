...
public class PersonController {
	...
	@PostMapping(value = "/findByLocation")
	public List<PersonDTO> getPersonsByLocation(@RequestBody LocationDTO locationDTO) {
		try {
			return personService.findByLocation(locationDTO.mapToEntity());
		} catch (Exception e) {
			log.error(e.getMessage());
			throw e;
		}
